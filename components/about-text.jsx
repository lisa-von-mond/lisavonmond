...
export default function AboutMe({color}){
    return(
        ...
        <p>My EP lovely planet will be released at the end of this year. I'm currently working on techno releases.</p>
