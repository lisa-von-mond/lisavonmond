...
export default function PrivacyText({color}){

return(

  <PrivacyTextWrapper color={color}>

      <h2>LEGAL NOTICE + PRIVACY POLICY</h2>
      <p>corresponding to § 5 TMG:<br></br>
      Lisa Luetkefedder / Lisa de Lune<br></br>
      represented by<br></br>
      Lisa Luetkefedder // Fährstraße 56 // 21107 Hamburg<br></br>
      lisavonmond@posteo.de</p>
